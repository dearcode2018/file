...
import com.hua.util.AntZipUtil;
 ...
 * AntZipUtilTest
 */
public final class AntZipUtilTest extends BaseTest {
	 ...
	 */
	@Test
	public void testAntZipUtil() {
		try {
			
			
		} catch (Exception e) {
			log.error("testAntZipUtil =====> ", e);
		}
	}
	/**
	 * 
	...
	public void testZip() {
		try {
			...
			AntZipUtil.zip(filePath, destZipPath);
	...
	public void testUnzip() {
		try {
			...
			AntZipUtil.unzip(filePath, destUzipPath);
